...
void main() {
	int fd;
	/* Assume that /etc/cap is an important system file, and it is owned by root with permission 0644. Before running this program, you should create the file /etc/cap first. */
