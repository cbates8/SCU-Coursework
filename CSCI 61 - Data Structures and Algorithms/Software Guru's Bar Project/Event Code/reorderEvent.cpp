/*
  Used to define the member function processEvent() of reorderEvent Class
...
void ReorderEvent::processEvent() {
  cout << "Time: " << bar.simulation.currentTime;
  cout << " Group of " << groupSize << " reorders" << endl;
  vector<int> v;
  v.push_back(15);
  v.push_back(60);
  v.push_back(25);
  ...
  for(int i = 0; i < groupSize; i++) {
    bar.reorder(weightedProbability(v, 1, 3));
  }
